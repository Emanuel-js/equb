...
class SalesSearchPlacesScreen extends StatefulWidget {
  const SalesSearchPlacesScreen({Key? key}) : super(key: key);

  @override
  State<SalesSearchPlacesScreen> createState() =>
      _SalesSearchPlacesScreenState();
}

const kGoogleApiKey = Api.api_key;
final homeScaffoldKey = GlobalKey<ScaffoldState>();

class _SalesSearchPlacesScreenState extends State<SalesSearchPlacesScreen> {
        ...
        children: [
          GoogleMap(
            ...
            onTap: (controler) {
              ...
              _adminController.long = controler.longitude;
              googleMapController
...
//  detail.result.name
  Future<void> displayPrediction(
    ...
    _adminController.long = lng;
    markersList.clear();
    addMarker(LatLng(_adminController.lat!, _adminController.long!),
        detail.result.name);
    googleMapController.animateCamera(CameraUpdate.newLatLngZoom(
        LatLng(_adminController.lat!, _adminController.long!), 14.0));
  }
