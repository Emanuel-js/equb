...
class AdminWallet extends StatefulWidget {
  ...
  @override
  State<AdminWallet> createState() => _MainCollectorWalletScreenState();
}

class _MainCollectorWalletScreenState extends State<AdminWallet> {
                        ...
                        : ElevatedButton.icon(
                            ...
                            onPressed: () {
                              if (_globalKey.currentState!.validate()) {
                                _walletService.topUpWallet(TransactionModel(
