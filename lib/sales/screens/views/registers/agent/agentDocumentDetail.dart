...
class AgentUploadDocument extends StatefulWidget {
  const AgentUploadDocument({Key? key}) : super(key: key);

  @override
  State<AgentUploadDocument> createState() => _AgentUploadDocumentState();
}

class _AgentUploadDocumentState extends State<AgentUploadDocument> {
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      if (_salesService.imageFile != null) {
                        _salesService.registerAgent(_salesService.agentReq!,
