...
import 'package:equb/sales/screens/views/registers/agent/agentDetailInformation.dart';
...
class RegisterAgentScreen extends StatefulWidget {
  const RegisterAgentScreen({Key? key}) : super(key: key);
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                if (_globalKey.currentState!.validate()) {
                                  ...
                                  Get.to(() => const AgentDetailInformation());
                                }

                                if (_salesService.isLoading) {
