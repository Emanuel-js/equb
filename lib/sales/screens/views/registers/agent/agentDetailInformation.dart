...
import 'package:equb/sales/screens/views/registers/agent/agentDocumentDetail.dart';
import 'package:equb/sales/screens/views/registers/agent/agentLocation.dart';
...
class AgentDetailInformation extends StatefulWidget {
  const AgentDetailInformation({Key? key}) : super(key: key);

  @override
  State<AgentDetailInformation> createState() => _AgentDetailInformationState();
}

class _AgentDetailInformationState extends State<AgentDetailInformation> {
            ...
            SizedBox(
              ...
              child: Container(
                child: ElevatedButton.icon(
                  ...
                  onPressed: () {
                    {
                      Get.to(() => const AgentLocationScreen());
                    }
                  },
                  label: Container(
                    alignment: Alignment.centerLeft,
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      if (_globalKey.currentState!.validate() &&
                        ...
                        Get.to(() => const AgentUploadDocument());
                      }
