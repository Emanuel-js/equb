...
class _UserLocationScreenState extends State<UserLocationScreen> {
  final _salesServices = Get.find<SalesService>();
      ...
      body: Stack(
        children: [
          GoogleMap(
            ...
            onTap: (controler) {
              _salesServices.lat = controler.latitude;
              _salesServices.long = controler.longitude;
              googleMapController
...
//  detail.result.name
  Future<void> displayPrediction(
    ...
    _salesServices.lat = lat;
    _salesServices.long = lng;
    markersList.clear();
    addMarker(
        LatLng(_salesServices.lat!, _salesServices.long!), detail.result.name);
    googleMapController.animateCamera(CameraUpdate.newLatLngZoom(
        LatLng(_salesServices.lat!, _salesServices.long!), 14.0));
  }
